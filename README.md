...
4. Predict salary for the dataset or new levels
5. Visualize the results (High-resolution curve)

## Program:
```
/*
Program to implement the Decision Tree Regressor Model for Predicting the Salary of the Employee.
Developed by: K. NIVEDHA
RegisterNumber: 25013942
*/
```
#Import libraries
import pandas as pd
...
## Output:
<img width="1132" height="719" alt="image" src="https://github.com/user-attachments/assets/e20e3747-2215-4c3b-a23f-95ca3f9fe85b" />
